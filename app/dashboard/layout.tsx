    ...
    <div className={`${exo.variable} font-sans min-h-screen dashboard-page text-gray-800 overflow-x-hidden`}>
      ...
      {isConnected && (
        <>
          ...
          <div className={`fixed inset-y-0 left-0 h-[90vh] my-auto transition-transform duration-300 ease-in-out z-50 ${sidebarCollapsed ? '-translate-x-full md:translate-x-0 w-[280px] xs:w-[320px] sm:w-[360px] md:w-60' : 'translate-x-0 w-[280px] xs:w-[320px] sm:w-[360px] md:w-60'
            }`}>
            ...
            <div className="h-full m-2 xs:m-3 sm:m-4 rounded-2xl relative bg-white/95 md:bg-transparent backdrop-blur-xl md:backdrop-blur-0 border border-gray-200 md:border-0 shadow-2xl md:shadow-none overflow-y-auto">
              ...
              <div className="relative h-full flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto pt-8 xs:pt-10 sm:pt-12 pb-4 px-2 xs:px-3 sm:px-3 mb-4">
                  <Link href="/dashboard" onClick={handleMobileNavClick} className={`group flex items-center ${sidebarCollapsed ? 'px-3 py-4 justify-center' : 'px-3 xs:px-4 py-3 xs:py-4'} mb-1 xs:mb-2 rounded-xl mx-1 transition-all duration-300 ${isActive('/dashboard')
                  ...
                  <Link href="/dashboard/plans" onClick={handleMobileNavClick} className={`group flex items-center ${sidebarCollapsed ? 'px-3 py-4 justify-center' : 'px-3 xs:px-4 py-3 xs:py-4'} mb-1 xs:mb-2 rounded-xl mx-1 transition-all duration-300 ${isActive('/dashboard/plans')
                    ? 'bg-gradient-to-r from-[#81D7B4]/30 to-[#6BC7A0]/20 text-[#2D5A4A] shadow-lg backdrop-blur-sm border border-[#81D7B4]/30'
                    : 'hover:bg-white/40 text-gray-700 hover:text-gray-900 hover:shadow-md hover:backdrop-blur-sm hover:border hover:border-white/40 transform hover:scale-[1.02]'
                    }`}>
                    <div className="relative">
                  ...
                  <Link href="/dashboard/activity" onClick={handleMobileNavClick} className={`group flex items-center ${sidebarCollapsed ? 'px-3 py-4 justify-center' : 'px-3 xs:px-4 py-3 xs:py-4'} mb-1 xs:mb-2 rounded-xl mx-1 transition-all duration-300 ${isActive('/dashboard/activity')
                    ? 'bg-gradient-to-r from-[#81D7B4]/30 to-[#6BC7A0]/20 text-[#2D5A4A] shadow-lg backdrop-blur-sm border border-[#81D7B4]/30'
                    : 'hover:bg-white/40 text-gray-700 hover:text-gray-900 hover:shadow-md hover:backdrop-blur-sm hover:border hover:border-white/40 transform hover:scale-[1.02]'
                    }`}>
                    <div className="relative">
                  ...
                  <Link href="/dashboard/social" onClick={handleMobileNavClick} className={`group flex items-center ${sidebarCollapsed ? 'px-3 py-4 justify-center' : 'px-3 xs:px-4 py-3 xs:py-4'} mb-1 xs:mb-2 rounded-xl mx-1 transition-all duration-300 ${isActive('/dashboard/social')
                    ? 'bg-gradient-to-r from-[#81D7B4]/30 to-[#6BC7A0]/20 text-[#2D5A4A] shadow-lg backdrop-blur-sm border border-[#81D7B4]/30'
                    : 'hover:bg-white/40 text-gray-700 hover:text-gray-900 hover:shadow-md hover:backdrop-blur-sm hover:border hover:border-white/40 transform hover:scale-[1.02]'
                    }`}>
                    <div className="relative">
                  ...
                  <Link href="/dashboard/leaderboard" onClick={handleMobileNavClick} className={`group flex items-center ${sidebarCollapsed ? 'px-3 py-4 justify-center' : 'px-3 xs:px-4 py-3 xs:py-4'} mb-1 xs:mb-2 rounded-xl mx-1 transition-all duration-300 ${isActive('/dashboard/leaderboard')
                    ? 'bg-gradient-to-r from-[#81D7B4]/30 to-[#6BC7A0]/20 text-[#2D5A4A] shadow-lg backdrop-blur-sm border border-[#81D7B4]/30'
                    : 'hover:bg-white/40 text-gray-700 hover:text-gray-900 hover:shadow-md hover:backdrop-blur-sm hover:border hover:border-white/40 transform hover:scale-[1.02]'
                    }`}>
                    <div className="relative">
                  ...
                  <Link href="/dashboard/referrals" onClick={handleMobileNavClick} className={`group flex items-center ${sidebarCollapsed ? 'px-3 py-4 justify-center' : 'px-3 xs:px-4 py-3 xs:py-4'} mb-1 xs:mb-2 rounded-xl mx-1 transition-all duration-300 ${isActive('/dashboard/referrals')
                    ? 'bg-gradient-to-r from-[#81D7B4]/30 to-[#6BC7A0]/20 text-[#2D5A4A] shadow-lg backdrop-blur-sm border border-[#81D7B4]/30'
                    : 'hover:bg-white/40 text-gray-700 hover:text-gray-900 hover:shadow-md hover:backdrop-blur-sm hover:border hover:border-white/40 transform hover:scale-[1.02]'
                    }`}>
                    <div className="relative">
                  ...
                  <Link href="/dashboard/create-savings" onClick={handleMobileNavClick} className={`group flex items-center ${sidebarCollapsed ? 'px-3 py-4 justify-center' : 'px-3 xs:px-4 py-3 xs:py-4'} mb-1 xs:mb-2 rounded-xl mx-1 transition-all duration-300 ${isActive('/dashboard/create-savings')
                    ? 'bg-gradient-to-r from-[#81D7B4]/30 to-[#6BC7A0]/20 text-[#2D5A4A] shadow-lg backdrop-blur-sm border border-[#81D7B4]/30'
                    : 'hover:bg-white/40 text-gray-700 hover:text-gray-900 hover:shadow-md hover:backdrop-blur-sm hover:border hover:border-white/40 transform hover:scale-[1.02]'
                    }`}>
                    <div className="relative">
                  ...
                  <Link href="/dashboard/settings" onClick={handleMobileNavClick} className={`group flex items-center ${sidebarCollapsed ? 'px-3 py-4 justify-center' : 'px-3 xs:px-4 py-3 xs:py-4'} mb-1 xs:mb-2 rounded-xl mx-1 transition-all duration-300 ${isActive('/dashboard/settings')
                    ? 'bg-gradient-to-r from-[#81D7B4]/30 to-[#6BC7A0]/20 text-[#2D5A4A] shadow-lg backdrop-blur-sm border border-[#81D7B4]/30'
                    : 'hover:bg-white/40 text-gray-700 hover:text-gray-900 hover:shadow-md hover:backdrop-blur-sm hover:border hover:border-white/40 transform hover:scale-[1.02]'
                    }`}>
                    <div className="relative">
