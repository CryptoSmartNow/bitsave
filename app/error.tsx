    ...
    <div className={`${exo.variable} font-sans min-h-screen bg-[#F8FAF9] flex items-center justify-center p-6 overflow-hidden relative`}>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center justify-center text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-100 shadow-sm mb-6">
          <div className="w-2 h-2 rounded-full bg-red-400 shadow-[0_0_8px_rgba(248,113,113,0.8)] animate-pulse" />
          <span className="text-xs font-bold text-gray-500 tracking-widest uppercase">System Error</span>
        </div>
        ...
        <p className="text-gray-500 text-lg leading-relaxed max-w-md mx-auto mb-10 font-medium">
          Our servers encountered an unexpected issue while processing your request. Don't worry, your funds are perfectly safe.
        </p>

        {/* Action buttons */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full max-w-lg mb-8">
          <button
            onClick={() => reset()}
